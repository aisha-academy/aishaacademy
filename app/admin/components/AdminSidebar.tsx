  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-[#1a0a05] flex flex-col z-50 shadow-2xl">
      ...
      <div className="p-6 border-b border-white/10 flex flex-col items-center">
        <Link href="/admin" className="block transform hover:scale-105 transition-transform duration-200">
          <Image
        ...
        <p className="text-amber-200/40 text-[10px] uppercase tracking-widest mt-2 font-medium">
